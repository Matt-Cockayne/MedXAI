"""
Example: Evaluate explainability methods on MedMNIST DermaMNIST dataset.

This script demonstrates:
- Loading DermaMNIST (skin lesion classification from ISIC)
- Generating explanations with multiple methods
- Quantitative evaluation with deletion/insertion metrics
- Visualizing results
"""
...
from utils import (
    get_medical_dataset, create_dataloader, load_model,
...
def main():
    print("=" * 70)
    print("MedMNIST DermaMNIST Explainability Evaluation")
    print("=" * 70)
    ...
    print(f"   Classes: 7 (skin lesion types)")
    print(f"   Image size: 28x28 (will be resized to 224x224)\n")
    
    # Load model
    print("Loading ResNet50 model...")
    model = load_model('resnet50', num_classes=7, device=device)
    print("Model loaded\n")
    ...
    explainers = {
        ...
        'RISE': RISE(model, device, n_masks=1000)  # Reduced for speed
    }
